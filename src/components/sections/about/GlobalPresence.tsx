...
function WorldMapSVG() {
  return (
    ...
    >
      ...
      <circle cx="570" cy="155" r="12" fill="rgba(59,130,246,0.35)" />
      <circle cx="570" cy="155" r="6" fill="var(--accent-500)">
      ...
      <circle cx="720" cy="185" r="14" fill="rgba(59,130,246,0.35)" />
      <circle cx="720" cy="185" r="7" fill="var(--accent-500)">
      ...
      <circle cx="500" cy="290" r="10" fill="rgba(59,130,246,0.35)" />
      <circle cx="500" cy="290" r="5" fill="var(--accent-500)">
      ...
      <circle cx="480" cy="90" r="9" fill="rgba(59,130,246,0.35)" />
      <circle cx="480" cy="90" r="5" fill="var(--accent-500)">
      ...
      <circle cx="250" cy="360" r="9" fill="rgba(59,130,246,0.35)" />
      <circle cx="250" cy="360" r="5" fill="var(--accent-500)">
