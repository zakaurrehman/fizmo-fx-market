...
// Simplified continent SVG paths (approximate outlines)
function WorldMapSVG() {
  return (
    ...
    >
      ...
      <circle cx="570" cy="155" r="12" fill="rgba(201,168,76,0.25)" />
      ...
      <circle cx="720" cy="185" r="14" fill="rgba(201,168,76,0.25)" />
      ...
      <circle cx="500" cy="290" r="10" fill="rgba(201,168,76,0.25)" />
      ...
      <circle cx="480" cy="90" r="9" fill="rgba(201,168,76,0.25)" />
      ...
      <circle cx="250" cy="360" r="9" fill="rgba(201,168,76,0.25)" />
        ...
        <ScrollReveal delay={0.1}>
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(to right, var(--bg-card) 0%, transparent 8%, transparent 92%, var(--bg-card) 100%)',
              }}
            />
            <div
              className="absolute inset-0 pointer-events-none z-10"
              style={{
                background:
                  'linear-gradient(to bottom, var(--bg-card) 0%, transparent 10%, transparent 90%, var(--bg-card) 100%)',
              }}
            />
